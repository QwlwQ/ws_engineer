...
bool duco_msg__srv__robot_move__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("duco_msg.srv._robot_move.RobotMove_Request", full_classname_dest, 42) == 0);
  }
  duco_msg__srv__RobotMove_Request * ros_message = _ros_message;
  {  // command
  ...
  {  // p
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'p'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // wobj
    ...
    rosidl_runtime_c__String__assign(&ros_message->wobj, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // block
...
PyObject * duco_msg__srv__robot_move__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("duco_msg.srv._robot_move");
  ...
  {  // p
    ...
    if (ros_message->p.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->p.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->p.size * sizeof(float));
      assert(data != NULL);
  ...
  {  // q
    ...
    if (ros_message->q.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->q.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->q.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // wobj
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->wobj.data,
      strlen(ros_message->wobj.data),
      "replace");
    if (!field) {
      return NULL;
    }
...
ROSIDL_GENERATOR_C_EXPORT
bool duco_msg__srv__robot_move__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("duco_msg.srv._robot_move.RobotMove_Response", full_classname_dest, 43) == 0);
  }
  duco_msg__srv__RobotMove_Response * ros_message = _ros_message;
  {  // response
