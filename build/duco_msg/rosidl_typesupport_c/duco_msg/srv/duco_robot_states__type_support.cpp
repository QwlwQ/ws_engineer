...
static const _DucoRobotStates_Request_type_support_symbol_names_t _DucoRobotStates_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duco_msg, srv, DucoRobotStates_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duco_msg, srv, DucoRobotStates_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, duco_msg, srv, DucoRobotStates_Request)() {
  return &::duco_msg::srv::rosidl_typesupport_c::DucoRobotStates_Request_message_type_support_handle;
}
...
static const _DucoRobotStates_Response_type_support_symbol_names_t _DucoRobotStates_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duco_msg, srv, DucoRobotStates_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duco_msg, srv, DucoRobotStates_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, duco_msg, srv, DucoRobotStates_Response)() {
  return &::duco_msg::srv::rosidl_typesupport_c::DucoRobotStates_Response_message_type_support_handle;
}
...
static const _DucoRobotStates_type_support_symbol_names_t _DucoRobotStates_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duco_msg, srv, DucoRobotStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duco_msg, srv, DucoRobotStates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, duco_msg, srv, DucoRobotStates)() {
  return &::duco_msg::srv::rosidl_typesupport_c::DucoRobotStates_service_type_support_handle;
}
