...
bool duco_msg__msg__virtual_servo_point_cloud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("duco_msg.msg._virtual_servo_point_cloud.VirtualServoPointCloud", full_classname_dest, 62) == 0);
  }
  duco_msg__msg__VirtualServoPointCloud * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of VirtualServoPointCloud */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("duco_msg.msg._virtual_servo_point_cloud");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VirtualServoPointCloud");
