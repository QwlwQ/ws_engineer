...
#include "duco_msg/srv/detail/robot_move__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duco_msg::srv::RobotMove_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const duco_msg::srv::RobotMove_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<duco_msg::srv::RobotMove_Request *>(
    untyped_ros_message);
...
static size_t _RobotMove_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotMove_Request(full_bounded, is_plain, 0);
...
{
  return &duco_msg::srv::typesupport_fastrtps_cpp::_RobotMove_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = duco_msg::srv::RobotMove_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const duco_msg::srv::RobotMove_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<duco_msg::srv::RobotMove_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _RobotMove_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotMove_Response(full_bounded, is_plain, 0);
...
{
  return &duco_msg::srv::typesupport_fastrtps_cpp::_RobotMove_Response__handle;
}
...
{
  return &duco_msg::srv::typesupport_fastrtps_cpp::_RobotMove__handle;
}
