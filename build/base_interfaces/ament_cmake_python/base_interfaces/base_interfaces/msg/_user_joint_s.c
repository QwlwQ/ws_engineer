...
bool base_interfaces__msg__user_joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces.msg._user_joint.UserJoint", full_classname_dest, 41) == 0);
  }
  base_interfaces__msg__UserJoint * ros_message = _ros_message;
  {  // joint0
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint0");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->joint0 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // joint1
...
{
  /* NOTE(esteve): Call constructor of UserJoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces.msg._user_joint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UserJoint");
  ...
  {  // joint0
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->joint0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "joint0", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
