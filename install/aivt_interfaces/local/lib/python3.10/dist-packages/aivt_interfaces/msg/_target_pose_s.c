...
bool aivt_interfaces__msg__target_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aivt_interfaces.msg._target_pose.TargetPose", full_classname_dest, 43) == 0);
  }
  aivt_interfaces__msg__TargetPose * ros_message = _ros_message;
  {  // target_pose
    ...
    }
    {
      ...
      Py_ssize_t size = 6;
      float * dest = ros_message->target_pose;
...
PyObject * aivt_interfaces__msg__target_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aivt_interfaces.msg._target_pose");
  ...
  {  // target_pose
    ...
    float * src = &(ros_message->target_pose[0]);
