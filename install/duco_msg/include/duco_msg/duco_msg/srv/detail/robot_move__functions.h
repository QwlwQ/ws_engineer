...
#ifndef DUCO_MSG__SRV__DETAIL__ROBOT_MOVE__FUNCTIONS_H_
#define DUCO_MSG__SRV__DETAIL__ROBOT_MOVE__FUNCTIONS_H_
 ...
 * calls
 * duco_msg__srv__RobotMove_Request__init().
...
/**
 * It calls
 * duco_msg__srv__RobotMove_Request__fini()
 ...
 * duco_msg__srv__RobotMove_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * duco_msg__srv__RobotMove_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * duco_msg__srv__RobotMove_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_duco_msg
...
/**
 * It calls
 * duco_msg__srv__RobotMove_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_duco_msg
...
/**
 * It allocates the memory for the array and calls
 * duco_msg__srv__RobotMove_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_duco_msg
...
/**
 * It calls
 * duco_msg__srv__RobotMove_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DUCO_MSG__SRV__DETAIL__ROBOT_MOVE__FUNCTIONS_H_
