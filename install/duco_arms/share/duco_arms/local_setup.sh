...
: ${AMENT_CURRENT_PREFIX:="/home/user/ws_siasun/install/duco_arms"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/duco_arms/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/duco_arms/environment/path.sh"
