...
class Metaclass_UserJoint(type):
    """Metaclass of message 'UserJoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'base_interfaces.msg.UserJoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__user_joint
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__user_joint
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__user_joint
            cls._TYPE_SUPPORT = module.type_support_msg__msg__user_joint
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__user_joint
...
class UserJoint(metaclass=Metaclass_UserJoint):
    """Message class 'UserJoint'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.joint0 = kwargs.get('joint0', float())
    ...
    def joint0(self, value):
        if __debug__:
            assert \
                ...
                "The 'joint0' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'joint0' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._joint0 = value
