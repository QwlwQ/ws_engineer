...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/ws_engineer/install/engineer_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/engineer_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/engineer_config/environment/path.sh"
